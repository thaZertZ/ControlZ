...
The project is *very* far from being finished, but
...
- [ ] Implement configuration scripts and build options satisfying
  different configuration options
- [ ] Make backend implementations configuration-agnostic
- [ ] Implement headless server functionality
- [ ] Implement headless client functionality
- [ ] Implement a GUI with `Dear ImGui`
...
especially on the GUI side and for testing critical code.
